...
5. [] Review the recent tasks then click the **Power On** text link in the **Commands** pane.
6. [] Select **VEEAM-DC01**.
...
> Note: A failover plan has been completed – click Running to make sure it's no longer there

...
2. [] Verify you see VM groups named **Mission Critical – Exchange Servers** and **Mission Critical – Sharepoint Servers** and that they are both included. Each VM group represents a vSphere tag. Tags are by default collected every three hours from your production environment. Click the **Default** text link in the **Scopes** pane at the top.
